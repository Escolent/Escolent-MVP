...
Escolent MVP is an AI-native adaptive learning platform targeting Grade 8 Mathematics (IEB-aligned, starting with algebraic equations). The platform operates as an embedded layer within existing LMS systems (Canvas, Moodle, Google Classroom) to provide adaptive, personalized practice with honest mastery tracking. The core problem being solved is that schools track completion rather than mastery—students can finish exercises without understanding the material.
...
- **Student**: A Grade 8 learner using the Platform within their school's LMS
...
- **Skill**: An atomic mathematical concept or procedure from the Grade 8 algebra curriculum
...
- **Practice_Problem**: A mathematical question presented to a Student during a Session
...
**User Story:** As a Teacher, I want the Platform to understand prerequisite relationships between Grade 8 algebra skills, so that remediation targets foundational gaps rather than surface symptoms.

#### Acceptance Criteria

1. THE Skill_Graph SHALL represent all Grade 8 algebraic equation Skills defined in the IEB curriculum
...
1. THE Platform SHALL maintain a Misconception_Taxonomy for Grade 8 algebraic equations
